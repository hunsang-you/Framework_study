...
class ProtectedUser {
    constructor() {
        this.x = 10; // private 붙이면 class {} 안에서만 사용가능
        this.y = 20; // protected 붙이면 class {} 안에서 + extends 된 class {} 안에서 사용 가능
    }
}
...
class Homework {
    constructor() {
        ...
        this.z = 30; // class {}안에서만 사용 가능 + extends 된 class{}안에서 사용가능?
        // private와 유사하게 class 내부에서만 사용 가능 + extends로 복사한 class 내부에서도 사용
    }
}
Homework.x = 10; // class {} 안에서만 사용 가능 + 부모class에 직접 부여됨(자식상속x)?
// class 내부에서만 수정가능
Homework.y = 20; // 모든자식들이 사용 가능 + 정적?
// 숙제2
class Homework2 {
    static addOne(num) {
        Homework2.x += num;
